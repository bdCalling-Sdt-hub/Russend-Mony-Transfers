class ApiUrl {
  ...
  static const String exchangeApi =
      "http://api.exchangeratesapi.io/v1/latest?access_key=e3f73a368e78b975be3d1048e30b9e8f";

  ///========================================> exchangeApi <==================================

  // static const String baseUrl = "https://russend.com" ;
  static const String baseUrl = "http://192.168.10.137:3000";
  ...
  static const String signInWithPasscode =
      "$baseUrl/api/users/sign-in-with-passcode";
  ...
  static const String termsOfMoneyTransfer =
      "$baseUrl/api/terms-of-money-transfers";

  static const String termsOfService = "$baseUrl/api/terms-of-services";

  static const String personalDataPolicies =
      "$baseUrl/api/personal-data-policies";

  static const String refundAndCancellationPolicy =
      "$baseUrl/api/refund-and-cancellation-policies";

  static const String user = "$baseUrl/api/users";

  static const String localAuth =
      "$baseUrl/api/users/sign-in-with-refresh-token";

  static const String notification = "$baseUrl/api/notifications";

  static const String paymentInfo = "$baseUrl/api/payment-info";

  static const String verifyOldPasscode =
      "$baseUrl/api/users/verify-old-passcode";
